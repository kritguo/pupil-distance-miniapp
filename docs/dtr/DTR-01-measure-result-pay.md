...
| `TEST-SUITE` | test | `npm test`（126 用例） | `tests/*.test.js` | 2026-07-04 全绿 |
...
- `npm test`：126 用例全绿（基线 2026-07-05）。
